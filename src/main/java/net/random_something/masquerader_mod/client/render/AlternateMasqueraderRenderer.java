...
import net.random_something.masquerader_mod.client.render.layer.AlternateMasqueraderArmorLayer;
...
@OnlyIn(Dist.CLIENT)
public class AlternateMasqueraderRenderer<T extends Masquerader> extends MobRenderer<T, AlternateMasqueraderModel<T>> {
    private static final ResourceLocation NO_MASK = new ResourceLocation(MasqueraderMod.MOD_ID, "textures/entity/masquerader/alternate/masquerader.png");
    private static final ResourceLocation EVOKER_MASK = new ResourceLocation(MasqueraderMod.MOD_ID, "textures/entity/masquerader/alternate/masquerader_evoker.png");
    private static final ResourceLocation ILLUSIONER_MASK = new ResourceLocation(MasqueraderMod.MOD_ID, "textures/entity/masquerader/alternate/masquerader_illusioner.png");
    private static final ResourceLocation RAVAGER_MASK = new ResourceLocation(MasqueraderMod.MOD_ID, "textures/entity/masquerader/alternate/masquerader_ravager.png");
    private static final ResourceLocation WITCH_MASK = new ResourceLocation(MasqueraderMod.MOD_ID, "textures/entity/masquerader/alternate/masquerader_witch.png");

    public AlternateMasqueraderRenderer(EntityRendererProvider.Context context) {
        super(context, new AlternateMasqueraderModel<>(context.bakeLayer(AlternateMasqueraderModel.LAYER_LOCATION)), 0.5F);
        this.addLayer(new AlternateMasqueraderArmorLayer<>(this));
