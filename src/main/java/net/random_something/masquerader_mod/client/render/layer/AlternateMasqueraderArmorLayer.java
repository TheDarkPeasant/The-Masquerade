...
@OnlyIn(Dist.CLIENT)
public class AlternateMasqueraderArmorLayer<T extends LivingEntity> extends EyesLayer<T, AlternateMasqueraderModel<T>> {
    private static final RenderType LAYER = RenderType.eyes(new ResourceLocation(MasqueraderMod.MOD_ID, "textures/entity/masquerader/alternate/masquerader_armor.png"));

    public AlternateMasqueraderArmorLayer(RenderLayerParent<T, AlternateMasqueraderModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
