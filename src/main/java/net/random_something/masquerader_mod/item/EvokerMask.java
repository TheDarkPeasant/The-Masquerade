...
public class EvokerMask extends ArmorItem {
    public EvokerMask(ArmorMaterial p_40386_, EquipmentSlot p_40387_, Properties p_40388_) {
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> list, TooltipFlag p_41424_) {
        list.add(Component.translatable("tooltip.masquerader_mod.evoker_mask").withStyle(ChatFormatting.ITALIC));
    ...
    public @Nullable String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        if (Config.alternateTextures.get())
            return MasqueraderMod.MOD_ID + ":textures/models/armor/alternate/evoker_mask.png";

        return MasqueraderMod.MOD_ID + ":textures/models/armor/evoker_mask.png";
    }
